...
CFLAGS = -Wall -O3
CPPFLAGS = -I.
LDFLAGS = -lm -lSDL2_image -lSDL2_ttf -lfftw3
...
SOURCES = audioHelper.c animations.c window.c circle.c mandelBrot.c tree.c circle_sierpinski.c credits.c buddhabrot.c
OBJ = $(SOURCES:.c=.o)
DOXYFILE = documentation/Doxyfile
EXTRAFILES = COPYING  $(wildcard shaders/*.?s images/*) takeonme.mod sprite.png
